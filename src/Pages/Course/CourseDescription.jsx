...
const {role,data}=useSelector((state)=>
  ...
  return (
    <HomeLayout>
      <div
        className="min-h-[90vh] pt-12 px-20 flex
            ...
            <div className="space-y-4">
              ...
              </div>
              {
                role==="ADMIN" || data?.subscription?.status==="ACTIVE" ? (
                    <button className="bg-yellow-600 text-xl rounded-md font-bold px-3 py-3 w-full
                    hover:bg-yellow-500 transition-all ease-in-out duration-300
                    ">
                        Watch Lectures
                    </button>
                ):(
